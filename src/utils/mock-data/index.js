...
const mockData = {
  ...
  image: {
    cover: (index) => `/static/mock-images/covers/cover_${index + 1}.webp`,
    feed: (index) => `/static/mock-images/feeds/feed_${index + 1}.webp`,
    product: (index) => `/static/mock-images/products/product_${index + 1}.webp`,
    avatar: (index) => `/static/mock-images/avatars/avatar_${index + 1}.webp`
  }
};
