const services = [
  {
    ...
    points: [
      {
        header: 'Consistent Support',
        description: 'Being a leading software development company in India, our focus is to provide consistent support and assistance to our worldwide clientele.'
      },
      {
    ...
    info: [
      'The pace at which digitization is accelerating, it has become critical for new-age businesses to invest in customized digital experiences to compete in today’s dynamic business ecosystem.',
      ' Owing to our decades of experiences in offering customized and high-performing customized software solutions, we utilize modern technologies and advanced approaches like Agile and DevOps to accelerate the time-to-market of your applications with a focus on delivering powerful, scalable, and cutting-edge software solutions. Our result-driven custom software development services include a host of services including Custom CRM, Custom ERP, Enterprise software development, Digital product development, SaaS development, Cloud-enabled development, Software consulting, and Custom software solutions.',
    ]
  },
  {
    ...
    heroimg: '/static/services/hire-developers.webp',
    icon: '/static/services/4hd.png',
    content: 'Hire dedicated team from Technozis and execute at speed and scale.',
    points: [
      {
        header: 'Expertise in Legacy & modern Tech',
        description: 'Agile or waterfall systems– we have expertise in all development methods'
      },
      {
        header: 'Value-driven engagemnet models',
        description: 'The pay as you use model requires you to pay more only when utilizing extra services'
      },
    ],
    info: [
      'To support the continuous change, organizations have a continuous requirement of designing and developing software solutions.',
      ' Hence, there is an ongoing need to hire dedicated software/web developers who are experts and proficient in varied technologies. ',
      'Get access to On - Demand Talent and upscale your business with a set of dedicated developers, experts in multiple technology fields, committed to driving your visions into reality.'
    ]
  },
  {
    ...
    heroimg: '/static/services/tcmain2.webp',
    ...
    info: [
      'Being customer-first company. Our job doesn\'t stop at developing technology but we cover the whole journey together to make you successful.',
      ' With our proven IT Support Services experience, we help our customers beyond regular development, testing and deployment.',
      ' Right from designing your digital transformation roadmap to making the technology live, our experts will stay with you in the entire journey. Our versatile & skilled technology consultants are experts in all peripheries of IT consulting, growing your business multifold, maximizing your RoI to the apex and proving that they are not just development partners, but much more.'
    ]
  },
  {
    ...
    heroimg: '/static/services/digital-transformation.webp',
  ...
  },
  {
    ...
    path: '/services/sap',
    heroimg: '/static/services/sapmain2.webp',
    ...
    points: [
      {
        header: 'Excellent Talent Pool',
        description: 'Housing the best-in-class talents, our experts employs the top methods to deleiver the right execution'
      },
      {
        header: 'Best-in-class support',
        description: 'Multinational implementations, rollouts and support"'
      },
    ],
    info: [
      ...
      'Technozis offers a comprehensive set of SAP services:',
      '- SAP Application Management Services',
      '- SAP Platform Modernization ',
      '-  SAP S/4 HANA Migration & Transition Services',
      '- SAP S/4 HANA Implementation Services',
      '- SAP Technology Platform and Infrastructure Services',
    ]
  },
  {
    ...
    heroimg: '/static/services/software-testing2.webp',
  ...
  },
  {
    ...
    heroimg: '/static/services/system-integration.webp',
    ...
    points: [
      {
        ...
        description: 'Consistent high-quality outcomes with agile teams of domain experts and dedicated QA practices'
      },
      {
        header: 'Complete Transparency',
        description: 'Transparent project management with strict adherence to deadlines."'
      },
    ],
    info: ['To keep up with the rapid pace of customer demands, it has become central for any business to act with agility.',
      ' With our application integration services, you can seamlessly connect all your business applications, databases, and business intelligence infrastructure and speed up your workflows and streamline the functioning of your operational activities.',
      ' Our enterprise application integration services includes Data integration services, API integration services, Business application integrations, and Service oriented architect.',
    ]
  },
  {
    ...
    heroimg: '/static/services/product-engineering.webp',
  ...
  },
  {
    ...
    heroimg: '/static/services/emmain.webp',
    ...
    points: [
      {
        header: 'Multi-domain Exposure',
        description: 'We possess experience working in almost all industry verticals, enabling digital-driven workflows.'
      },
      {
        header: 'Agile Approach',
        description: 'We follow modern approach to enterprise app development like agile and DevOps to deliver apps faster."'
      },
    ],
  ...
  },
  {
    ...
    points: [
      {
        header: 'Seamless Execution',
        description: 'Access to experienced team along with transparent communication and seamless project execution'
      },
      {
        header: 'Reduced Costs',
        description: 'Driving your application in the right direction with minimal costs and boost productivity"'
      },
    ],
    info: [
      'Building a strong technology backbone is for business will ensur elong-term success.',
      ' Weaving teh right tecnology development requires latest trends and outstanding application development services that will not only help you save cost but also help you drive better outcome for your business.',
      ' Get access to services like Technology consulting, Custome application development, Testing & Quality Assurance, Protype Development, Application integration Services, and Application Support & Management and deliver immersive user experience. ',
      'Our team effectively deploy our immense industry experience and commendable technical expertise to develop applications that eliminates complexity from the process, automates business-critical tasks, and stremlines the entire business cycle. '
    ]
  },
  {
    ...
    heroimg: '/static/services/management-and-support.webp',
  ...
  },
  {
    ...
    heroimg: '/static/services/cloud-technology-main2.webp',
    ...
    points: [
      {
        header: 'The most sophisticated service',
        description: 'To protect and deliver your digital experiences, rely on Technozis\' unparalleled capacity and scale'
      },
      {
        header: 'Security is a Priority',
        description: 'Be it any type of software or app, security is our top priority at every level with strict adherence to security and privacy guideline"'
      },
    ],
    info: [
      'For cloud cost management, for speed, for security, for managing your data and running your enterprise, nothing beats the cloud.',
      ' It’s never been easier — or smarter — to manage services in a hybrid or 100% cloud environment.',
      ' The cloud is where you want to be for a modern ecosystem and all the benefits that it brings.',
      'We enable digital tranformation with cloud solutions that drive growth, scalability, and agility.',
      'Use our services to take charge of your environments in one place with control and visibility for web applications, cloud security, and content delivery.'
    ]
  },
  {
    ...
    heroimg: '/static/services/embedded-product.webp',
  ...
  },
  {
    ...
    heroimg: '/static/services/biamain2.webp',
