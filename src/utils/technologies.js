const TECHNOLOGY = [
  {
    ...
    points: [
      'Build great brand experience for your customers',
      'Create intuitive and business concentric user experience',
      'Optimize performance, reducing page-load times and deliver fast, light and SEO-friendly websites and apps'
    ],
    expertise: [
      {
        title: 'Angular JS',
  ...
  },
  {
    ...
    points: [
      'Increase brand awareness for greater reach among potential customers',
      'Improve direct communication with clients and customers and customer engagement',
      'Create an effective loyalty programme and encourage sales',
    ],
    expertise: [
      {
        title: 'IOS',
  ...
  },
  {
    ...
    points: [
      "Easy access to your company's data will save time and money",
      'Leverage data and insights that improves efficiency and speed of your business',
      'Makes collaboration a simple provcess improving process efficiency and faster delivery',
    ],
    expertise: [
      {
        title: 'AWS',
  ...
  },
  {
    ...
    points: [
      'Broaden your brand, expand your business, and diversify sales in less cost',
      'Engage and build trust with your customers with right e-commerce marketing solutions',
      'Maximize the security of transactions and ensure trust and safety',
    ],
    expertise: [
      {
        title: 'Magneto',
  ...
  },
  {
    ...
    points: [
      'Build great cutomer relationships with better management of customers data and insights',
      'Plan growth startegies with right reporting capabilities',
      'Manage all your business-critical data centrally, safely and securely- whenever you need it'
    ],
    expertise: [
      {
        title: 'SQL Lerver',
  ...
  },
  {
    ...
    points: [
      'Creates a uniform look which is easier to work upon without worrying about coding',
      'Streamlines workflows for writers and designers without worrying about webpage layout',
      'Helps  develop an SEO ranking that drives traffic to the website and turns unique visitors into qualified leads'
    ],
    expertise: [
      {
        title: 'WordPress',
  ...
  },
  {
    ...
    points: [
      'Improve communication and collaboration between your team.',
      'Increase efficiency to speed the development process and make it less prone to error.',
      'Reduced overall costs and IT headcount requirements.'
    ],
    expertise: [
      {
        title: 'Azure Ops',
